...
function App() {
    ...
    return (_jsxs(Box, { bg: "#18181b", minH: "100vh", color: "white", children: [_jsx(Flex, { as: "nav", gap: 4, p: 4, justify: "center", bg: "#23232a", borderRadius: "xl", boxShadow: "md", children: tabs.map((tab) => (_jsx(Box, { as: "button", px: 5, py: 2, fontWeight: "bold", borderRadius: "md", bg: selected === tab.value ? "teal.400" : "#23232a", color: selected === tab.value ? "gray.900" : "gray.300", boxShadow: selected === tab.value ? "0 2px 8px #0bc5ea80" : undefined, border: selected === tab.value ? "2px solid #0bc5ea" : "2px solid transparent", transition: "all 0.2s", _hover: {
