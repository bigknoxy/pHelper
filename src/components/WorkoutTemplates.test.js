...
const mockWorkoutTemplatesApi = workoutTemplatesApi;
...
describe('WorkoutTemplates', () => {
    ...
    it('renders workout templates heading', async () => {
        renderWithQueryClient(_jsx(WorkoutTemplates, {}));
        await waitFor(() => {
    ...
    it('filters templates by category', async () => {
        ...
        expect(mockWorkoutTemplatesApi.getWorkoutTemplates).toHaveBeenCalledWith(expect.objectContaining({
            category: 'Strength',
        }));
    });
